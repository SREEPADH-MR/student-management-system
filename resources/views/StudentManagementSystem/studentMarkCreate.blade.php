                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="{{ route('studentMarkCreate') }}">
                                ...
                                <fieldset class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="term" id="term1" value="ONE" @checked(old('term')) required>
                                            <label class="form-check-label" for="term1">
                                                ONE
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="term" id="term2" value="TWO" @checked(old('term')) required>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="maths" class="form-control @error('maths') is-invalid @enderror" id="maths" value="{{ old('maths') }}" required>
                                @error('maths')
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="science" class="form-control @error('science') is-invalid @enderror" id="science" value="{{ old('science') }}" required>
                                @error('science')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-12">
                                ...
                                <input type="text" name="history" class="form-control @error('history') is-invalid @enderror" id="history" value="{{ old('history') }}" required>
                                @error('history')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
